...
CREATE TABLE `movierentals` (
  ...
  CONSTRAINT `fk_MovieRentals_Movies1` FOREIGN KEY (`reference_number`) REFERENCES `movies` (`movie_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `movierentals` VALUES (1,'0000-00-00','0000-00-00');
...
-- Dump completed on 2018-01-04 13:07:44
